...
export default class GenrePage extends React.Component {
    constructor(props) {
        super(props);
        this.state = {token: this.props.location.state.access_token, genreName: this.props.location.state.genre_name, songs: []};
        fetch("http://localhost:8080/api/getAllByGenre?genre=" + this.state.genreName, {
            method: "GET",
            headers: {
